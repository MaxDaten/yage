...
type YMaterialBaseColor  = "BaseColor"            ::: V4 GLfloat
type YMaterialSpecular   = "Specular"             ::: GLfloat
...
type YMaterial = [ YMaterialBaseColor, YMaterialSpecular ]
...
materialBaseColor :: YMaterialBaseColor
materialBaseColor = Field
